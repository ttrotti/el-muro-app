...
User.prototype.validate = function() {
    return new Promise(async (resolve, reject) => {
        ...
        if (this.data.username.length > 0 && this.data.username.length < 4) {this.errors.push('Username has to be at least 4 characters.')}
        ...
        // password
        if (this.data.password.length > 0 && this.data.password.length < 10) {this.errors.push('password has to be at least 10 characters.')}
