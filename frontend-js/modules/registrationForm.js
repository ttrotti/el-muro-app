...
export default class RegistrationForm {
    ...
    passwordAfterDelay() {
        if(this.password.value.length < 12) {
            this.showValidationError(this.password, "Password has to be at least 12 characters.")
        }
    }
    ...
    usernameAfterDelay() {
        if(this.username.value.length < 4) {
            this.showValidationError(this.username, "Username has to be at least 4 characters")
        }
